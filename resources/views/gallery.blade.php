...
.team .team_member .team_img img{
  ...
  <ul>
   ...
   <li><i class="fa fa-plane" aria-hidden="true"></i><a href="flights.html">Flights</a></li>  
   <li><i class="fa fa-map-marker" aria-hidden="true"></i><a href="#">Places to Explore</a></li>
